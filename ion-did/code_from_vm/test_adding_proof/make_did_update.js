...
const main = async () => {
    ...
    // Print initial DID document - not working
    // console.log(did.content)

    //Log update and recovery keys? - not working
    ...
    // console.log("****")
    // console.log(JSON.stringify(anchorRequestBody, null, 2))
    // console.log("****")
    ...
    //log operation
    console.log("****")
    console.log(JSON.stringify(updateOperation.previous, null, 2))
    // Write request body
    await fs.writeFile(
        'updateKey.json', 
         JSON.stringify(updateOperation.previous.update)
    );
    await fs.writeFile(
        'recoveryKey.json', 
         JSON.stringify(updateOperation.previous.recovery)
    );
    console.log("****")
    ...
    let createRequest = await did.generateRequest(updateOperation.previous);
    console.log(createRequest);
    console.log(JSON.stringify(createRequest, null, 2));
    await fs.writeFile(
        'anchorRequestBody-pre_update.json', 
