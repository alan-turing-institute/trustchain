...
mod tests {
    ...
    fn test_verification_method_deserialisation() {
        let mut json: serde_json::Value = serde_json::from_str(&RSS_VM_JSON.to_string()).unwrap();
