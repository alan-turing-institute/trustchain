...
// Handlers for requests relating to the attestation challenge-response protocol.

/// Handles a POST request for identity challenge-response initiation (part 1 of dDID attestation).
///
...
#[cfg(test)]
mod tests {
    use crate::attestation_utils::RequesterDetails;
